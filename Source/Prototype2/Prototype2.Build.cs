...
public class Prototype2 : ModuleRules
{
	public Prototype2(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "HeadMountedDisplay", "EnhancedInput", "OnlineSubsystemSteam", "OnlineSubsystem", "OnlineSubsystemUtils", "UMG", "Navmesh", "NavigationSystem", "Niagara", "NiagaraCore", "SlateCore"});
